...
def fig01_architecture():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig01_architecture.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig01_architecture.png')
    plt.close()
    print("  → fig01_architecture.pdf")
...
def fig02_baseline_comparison():
    ...
    fig.suptitle('Figure 2: Baseline Comparison — Intent F1, ROUGE-L, BLEU-4 (RQ1)\n'
                 ...
                 fontsize=10, y=1.01)
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig02_baseline_comparison.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig02_baseline_comparison.png')
    plt.close()
    print("  → fig02_baseline_comparison.pdf")
...
def fig03_rag_heatmap():
    ...
    fig.suptitle('Figure 3: RAG Configuration Heatmap — Faithfulness by Chunk Size × Top-k (RQ2)\n'
                 ...
                 fontsize=10, y=1.02)
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig03_rag_heatmap.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig03_rag_heatmap.png')
    plt.close()
    print("  → fig03_rag_heatmap.pdf")
...
def fig04_ragas_comparison():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig04_ragas_comparison.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig04_ragas_comparison.png')
    plt.close()
    print("  → fig04_ragas_comparison.pdf")
...
def fig05_faithfulness_scatter():
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig05_faithfulness_scatter.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig05_faithfulness_scatter.png')
    plt.close()
    print("  → fig05_faithfulness_scatter.pdf")
...
def fig06_roc_curves(df):
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig06_roc_curves.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig06_roc_curves.png')
    plt.close()
    print("  → fig06_roc_curves.pdf")
...
def fig07_escalation_tradeoff():
    ...
    fig.suptitle('Figure 7: Escalation Strategy Evaluation (RQ3)\nReal escalation rate=38% for multi-criteria policy',
                 fontsize=10, fontweight='bold')
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig07_escalation_tradeoff.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig07_escalation_tradeoff.png')
    plt.close()
    print("  → fig07_escalation_tradeoff.pdf")
...
def fig08_confusion_matrix(df):
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig08_confusion_matrix.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig08_confusion_matrix.png')
    plt.close()
    print("  → fig08_confusion_matrix.pdf")
...
def fig09_per_class_f1():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig09_per_class_f1.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig09_per_class_f1.png')
    plt.close()
    print("  → fig09_per_class_f1.pdf")
...
def fig10_radar_robustness():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig10_radar_robustness.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig10_radar_robustness.png')
    plt.close()
    print("  → fig10_radar_robustness.pdf")
...
def fig11_correlation_heatmap():
    ...
    ax.set_title('Figure 11: Metric Correlation Matrix (RQ5)\n'
                 ...
                 fontweight='bold', fontsize=10)
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig11_correlation_heatmap.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig11_correlation_heatmap.png')
    plt.close()
    print("  → fig11_correlation_heatmap.pdf")
...
def fig12_bertscore_scatter():
    ...
    ax.legend(fontsize=10)
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig12_bertscore_scatter.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig12_bertscore_scatter.png')
    plt.close()
    print("  → fig12_bertscore_scatter.pdf")
...
def fig13_latency_load():
    ...
    fig.suptitle('Figure 13: Scalability and Latency Under Load (RQ6)\n'
                 ...
                 fontsize=10, fontweight='bold')
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig13_latency_load.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig13_latency_load.png')
    plt.close()
    print("  → fig13_latency_load.pdf")
...
def fig14_latency_breakdown():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig14_latency_breakdown.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig14_latency_breakdown.png')
    plt.close()
    print("  → fig14_latency_breakdown.pdf")
...
def fig15_ablation():
    ...
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig15_ablation.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig15_ablation.png')
    plt.close()
    print("  → fig15_ablation.pdf")
...
def fig16_human_evaluation():
    ...
    fig.suptitle('Figure 16: Human Evaluation Results (RQ5)\nREAL values — 3 annotators, 30 Mistral-7B responses, 5 dimensions',
                 fontsize=10, fontweight='bold')
    plt.tight_layout()
    plt.savefig(FIG_DIR/'fig16_waterfall.pdf', format='pdf')
    plt.savefig(FIG_DIR/'fig16_waterfall.png')
    plt.close()
    print("  → fig16_waterfall.pdf")
